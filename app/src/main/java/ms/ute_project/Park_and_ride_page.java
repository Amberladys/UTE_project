...
public class Park_and_ride_page extends ListActivity {
    ...
    public class JsonParser extends AsyncTask<Void, Void, Integer> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(Park_and_ride_page.this);
                ...
                if(jsonStr.contains("\"data\":[")) {
                    try {
                        ...
                        for (int i = 0; i < data.length(); i++) {
                            ...
                            JSONObject nam = properties.getJSONObject(4);
                            JSONObject fre = properties.getJSONObject(5);
                            ...
                            data_tmp.put("free","wolne miejsca: " + free);
         ...
         * */
                    ...
                    Park_and_ride_page.this, dataList,
                    R.layout.park_list_item, new String[] { TAG_PROPERTIES_VALUE, "free", TAG_GEOMETRY_COORDINATES_LAT,
                            TAG_GEOMETRY_COORDINATES_LON, }, new int[] { R.id.name, R.id.free_space,
